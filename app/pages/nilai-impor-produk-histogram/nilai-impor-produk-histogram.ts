...
export class NilaiImporProdukHistogramPage {
  private url: String;
  ...
  private ngOnInit(): void {
    this.url = "https://api.kawaljakarta.org/v1/nilai-impor-produk-menurut-golongan/histogram";
  ...
  private loadData(url): void {
    this.dataService.load(this.url)
      .then(data => {
        ...
        this.options = this.loadOptions.loadOptionHistogram("frekuensi", 45, 40, 55);
      });
  }
